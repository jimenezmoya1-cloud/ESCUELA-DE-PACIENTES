export const countries = [
  ...
  { name: "Bahamas (The)", code: "BS", phoneCode: "+1-242" },
  ...
  { name: "British Indian Ocean Territory (the)", code: "IO", phoneCode: "+246" },
  ...
  { name: "Cayman Islands (the)", code: "KY", phoneCode: "+1-345" },
  { name: "Central African Republic (the)", code: "CF", phoneCode: "+236" },
  { name: "Chad", code: "TD", phoneCode: "+235" },
  { name: "Chile", code: "CL", phoneCode: "+56" },
  { name: "China", code: "CN", phoneCode: "+86" },
  { name: "Christmas Island", code: "CX", phoneCode: "+61" },
  { name: "Cocos (Keeling) Islands (the)", code: "CC", phoneCode: "+61" },
  { name: "Colombia", code: "CO", phoneCode: "+57" },
  { name: "Comoros (the)", code: "KM", phoneCode: "+269" },
  { name: "Congo (the Democratic Republic of the)", code: "CD", phoneCode: "+243" },
  { name: "Congo (the)", code: "CG", phoneCode: "+242" },
  { name: "Cook Islands (the)", code: "CK", phoneCode: "+682" },
  ...
  { name: "Dominican Republic (the)", code: "DO", phoneCode: "+1-809" },
  ...
  { name: "Falkland Islands (the) [Malvinas]", code: "FK", phoneCode: "+500" },
  { name: "Faroe Islands (the)", code: "FO", phoneCode: "+298" },
  ...
  { name: "French Southern Territories (the)", code: "TF", phoneCode: "+262" },
  { name: "Gabon", code: "GA", phoneCode: "+241" },
  { name: "Gambia (the)", code: "GM", phoneCode: "+220" },
  ...
  { name: "Heard Island and McDonald Islands", code: "HM", phoneCode: "+61" },
  { name: "Holy See (the)", code: "VA", phoneCode: "+379" },
  ...
  { name: "Korea (the Democratic People's Republic of)", code: "KP", phoneCode: "+850" },
  { name: "Korea (the Republic of)", code: "KR", phoneCode: "+82" },
  { name: "Kuwait", code: "KW", phoneCode: "+965" },
  { name: "Kyrgyzstan", code: "KG", phoneCode: "+996" },
  { name: "Lao People's Democratic Republic (the)", code: "LA", phoneCode: "+856" },
  ...
  { name: "Marshall Islands (the)", code: "MH", phoneCode: "+692" },
  ...
  { name: "Moldova (the Republic of)", code: "MD", phoneCode: "+373" },
  ...
  { name: "Philippines (the)", code: "PH", phoneCode: "+63" },
  ...
  { name: "Russian Federation (the)", code: "RU", phoneCode: "+7" },
  ...
  { name: "South Georgia and the South Sandwich Islands", code: "GS", phoneCode: "+500" },
  { name: "South Sudan", code: "SS", phoneCode: "+211" },
  { name: "Spain", code: "ES", phoneCode: "+34" },
  { name: "Sri Lanka", code: "LK", phoneCode: "+94" },
  { name: "Sudan (the)", code: "SD", phoneCode: "+249" },
  ...
  { name: "Syrian Arab Republic (the)", code: "SY", phoneCode: "+963" },
  { name: "Taiwan (Province of China)", code: "TW", phoneCode: "+886" },
  { name: "Tajikistan", code: "TJ", phoneCode: "+992" },
  { name: "Tanzania, the United Republic of", code: "TZ", phoneCode: "+255" },
  ...
  { name: "Turks and Caicos Islands (the)", code: "TC", phoneCode: "+1-649" },
  ...
  { name: "United Arab Emirates (the)", code: "AE", phoneCode: "+971" },
  { name: "United Kingdom of Great Britain and Northern Ireland (the)", code: "GB", phoneCode: "+44" },
  { name: "United States Minor Outlying Islands (the)", code: "UM", phoneCode: "+1" },
  { name: "United States of America (the)", code: "US", phoneCode: "+1" },
  ...
  { name: "Virgin Islands (British)", code: "VG", phoneCode: "+1-284" },
  { name: "Virgin Islands (U.S.)", code: "VI", phoneCode: "+1-340" },
